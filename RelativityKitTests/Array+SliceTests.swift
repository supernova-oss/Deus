...
struct ArraySliceTests {
  ...
  @Test
  func returnsOriginalSingleElementArrayWhenSlicingWithIndicesEqualToItsOwn()
    throws
  {
  ...
  @Test
  func returnsOriginalMultiElementArrayWhenSlicingWithIndicesEqualToItsOwn()
    throws
  {
