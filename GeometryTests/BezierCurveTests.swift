...
struct BezierCurveTests {
  ...
  func makesCubicBezierCurve() {
    ...
    let points = [
      Point.zero, Point(x: 0.0685, y: 0.028), Point(x: 0.128, y: 0.056),
      Point(x: 0.1845, y: 0.09), Point(x: 0.244, y: 0.136),
      Point(x: 0.3125, y: 0.2), Point(x: 0.396, y: 0.288),
      Point(x: 0.5005, y: 0.406), Point(x: 0.632, y: 0.56),
      Point(x: 0.7965, y: 0.756), Point(x: 1, y: 1)
    ]
