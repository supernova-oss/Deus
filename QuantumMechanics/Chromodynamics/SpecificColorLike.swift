...
/// Final state of confined ``ColoredParticle``s whose net ``Color`` charge is
/// zero, making them effectively colorless. Results from the combination of
/// ``Color``-anticolor pairs or of all ``SingleColor``s
/// (``red`` + ``green`` + ``blue``).
...
/// Final state of confined ``ColoredParticleLike``s whose net ``Color`` charge
/// is zero, making them effectively colorless. Results from the combination of
/// ``Color``-anticolor pairs or of all ``SingleColor``s
/// (``red`` + ``green`` + ``blue``).
