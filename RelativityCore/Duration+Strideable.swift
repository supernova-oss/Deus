...
extension Duration: @retroactive Strideable {
  ...
  ///
  /// - Parameter other: `Duration` whose distance in relation to this one will
  ///   be calculated.
  public func distance(to other: Duration) -> Int128 {
    other.attoseconds - attoseconds
  }

  /// Advances this `Duration` by the given amount of attoseconds.
  ///
  /// - Parameter n: Attoseconds towards which this `Duration` is to be
  ///   advanced.
